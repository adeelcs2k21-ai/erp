    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          View all quotations you have submitted
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        {/* Stats */}
        <div className="lg:col-span-4 grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <p className="text-3xl font-bold text-blue-600">
              {quotes
                .reduce(
                  (sum, q) =>
                    sum + q.items.reduce((s, item) => s + item.totalPrice, 0),
                  0
                )
                .toFixed(2)}
            </p>
          ...
          <div className="space-y-4">
            {quotes.length === 0 ? (
              <div className="bg-white rounded-lg shadow p-8 text-center">
                <p className="text-gray-500 mb-4">No quotes submitted yet</p>
                <a
                  href="/supplier"
